...
contract("TestBearcoin", accounts => {
  ...
  it("should never swing past the desired amount during inflation", async () => {
    ...
    await bearcoin.devSetCurrentBitcoinPrice(genesisPrice * 1050 / 1000); //Set to max inflation
...
contract("TestBearcoin", accounts => {
  ...
  it("should never swing past the desired amount during deflation", async () => {
    ...
    await bearcoin.devSetCurrentBitcoinPrice(genesisPrice * 950 / 1000); //Set to max deflation
